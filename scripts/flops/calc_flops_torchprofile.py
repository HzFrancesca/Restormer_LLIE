...
def calculate_flops_torchprofile(input_size=(1, 3, 400, 600)):
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="使用 torchprofile 计算 Restormer 的参数量和 FLOPs"
    )
    parser.add_argument(
        "--input-size",
        type=int,
    ...
    if result:
        ...
        output_file = os.path.join(
            os.path.dirname(__file__), "results_torchprofile.txt"
        )
